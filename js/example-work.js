        ...
        <div className="section__exampleWrapper">
          <div className="section__example">
            <img alt="example screenshot of a project involving chemistry"
                ...
                {/* jsx doesn't support html style block comments, use jsx style
                 curly brace tells jsx that you are about to use javascript
...
class WorkExampleBubbles extends React.Component {
  render() {
    return (
